...
[[nodiscard]] constexpr http_method 
enum2method(boost::beast::http::verb method) {
    switch (method) {
...
[[nodiscard]] constexpr std::string_view
to_string(route_match_type mt) {
    switch (mt) {
        case route_match_type::EXACT:  return "EXACT";
        case route_match_type::PREFIX: return "PREFIX";
    }
